...
pub struct TaskRun {
    ...
    /// App-level mode used to create the run: chat, cowork, or code.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    /// Internal background run. Hidden from history/sidebar/search/stats.
...
pub struct UserSettings {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub helioncoder_cli_path: Option<String>,
    pub updated_at: String,
}
...
impl Default for UserSettings {
    fn default() -> Self {
        Self {
            display_name: None,
            default_agent: "helioncoder".to_string(),
            default_model: None,
            allowed_tools: vec![],
...
impl Default for AllSettings {
    fn default() -> Self {
        ...
        agents.insert(
            "helioncoder".to_string(),
            AgentSettings::default_for("helioncoder"),
        );
        Self {
...
/// HelionCoder desktop usage stats persisted to ~/.helioncoder/helioncoder.sqlite.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct HelionUsageStats {
    ...
    pub by_model: Vec<HelionModelStats>,
    pub daily: Vec<HelionDailyStats>,
    pub sqlite_path: String,
}

#[derive(Debug, Clone, Serialize, Deserialize, Default)]
#[serde(rename_all = "camelCase")]
pub struct HelionModelStats {
    pub model: String,
    pub sessions: u32,
    pub messages: u64,
    pub input_tokens: u64,
...
pub struct AuthOverview {
    ...
    /// Source of CLI API key: "settings", "env:VAR", "shell_config:PATH", or None
    #[serde(skip_serializing_if = "Option::is_none")]
