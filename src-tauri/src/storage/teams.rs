...
/// Root of HelionCoder data: ~/.helioncoder/
...
/// List all teams by reading ~/.helioncoder/teams/*/config.json.
...
/// Delete a team by removing its directories from ~/.helioncoder/teams/{name} and ~/.helioncoder/tasks/{name}.
