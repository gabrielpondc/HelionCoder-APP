...
pub fn create_run(
    ...
    log::debug!(
        "[storage/runs] create_run: id={}, agent={}, model={:?}, parent={:?}, remote={:?}, platform={:?}, hidden={}, prompt_len={}",
        id,
        agent,
        model,
        parent_run_id,
...
fn should_hide_from_user(meta: &RunMeta) -> bool {
    meta.hidden
        || meta
            .prompt
            .trim_start()
            .starts_with(LIVE_DOC_AI_PROMPT_PREFIX)
}
