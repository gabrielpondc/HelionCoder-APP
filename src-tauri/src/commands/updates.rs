...
mod tests {
    ...
    fn test_select_download_url_prefers_dmg() {
        let body = json!({
            "html_url": "https://example.com/helioncoder/releases/tag/v0.1.14",
            "assets": [
                { "name": "HelionCoder-0.1.14.zip", "browser_download_url": "https://example.com/a.zip" },
                { "name": "HelionCoder_0.1.14_universal.dmg", "browser_download_url": "https://example.com/a.dmg" }
            ]
        });
        assert_eq!(
    ...
    fn test_select_download_url_prefers_msi() {
        let body = json!({
            ...
            "assets": [
                { "name": "HelionCoder-0.1.14.zip", "browser_download_url": "https://example.com/a.zip" },
                { "name": "HelionCoder_0.1.14_x64-setup.msi", "browser_download_url": "https://example.com/a.msi" },
                { "name": "HelionCoder_0.1.14_x64.exe", "browser_download_url": "https://example.com/a.exe" }
            ]
        });
    ...
    fn test_select_download_url_zip_fallback_on_windows() {
        ...
        let body = json!({
            "html_url": "https://example.com/helioncoder/releases/tag/v0.1.31",
            "assets": [
                { "name": "HelionCoder_0.1.31_universal.dmg", "browser_download_url": "https://example.com/a.dmg" },
                { "name": "HelionCoder_0.1.31_x64-setup.zip", "browser_download_url": "https://example.com/a.zip" }
            ]
        });
        assert_eq!(
    ...
    fn test_select_download_url_prefers_appimage() {
        let body = json!({
            "html_url": "https://example.com/helioncoder/releases/tag/v0.1.14",
            "assets": [
                { "name": "HelionCoder_0.1.14.AppImage", "browser_download_url": "https://example.com/a.AppImage" }
            ]
        });
        assert_eq!(
    ...
    fn test_select_download_url_falls_back_to_html() {
        ...
        assert_eq!(
            select_download_url_for_exts(&body, &[".dmg"]),
            "https://example.com/helioncoder/releases/tag/v0.1.14"
        );
    }
}
