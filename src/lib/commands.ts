...
export const commands: CommandDef[] = [
  ...
  {
    id: "new-claude",
    name: "New HelionCoder Chat",
    description: "Start a new HelionCoder conversation",
    category: "chat",
    agent: "both",
    action: "navigate",
    payload: "/chat?agent=helioncoder",
  },
  // Codex disabled
  // {
  //   id: "new-codex",
  ...
  },
  {
    ...
    description: "Check whether a newer HelionCoder app version is available",
    category: "diagnostics",
    agent: "both",
    action: "ipc_command",
  ...
  },
  {
    id: "update-cli",
    name: "Update CLI",
    description: "Run the HelionCoder CLI updater",
    category: "diagnostics",
    agent: "both",
    action: "ipc_command",
    payload: "update_cli",
  },
  {
    id: "version",
    name: "Version Info",
    description: "Show HelionCoder Desktop version information",
    category: "diagnostics",
    agent: "both",
    action: "open_modal",
