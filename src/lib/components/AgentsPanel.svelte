<script lang="ts">
  ...
  const builtInAgents: AgentDefinitionSummary[] = [
    ...
    {
      file_name: "helion-guide",
      name: "helion-guide",
      description:
        "Agent for answering questions about Helion features, hooks, slash commands, MCP servers, settings, and IDE integrations.",
      model: "haiku",
      source: "built-in",
      scope: "user",
    ...
    },
    {
      ...
      description: "Agent to configure the user's Helion status line setting.",
      model: "sonnet",
      source: "built-in",
      scope: "user",
      tools: ["Read", "Edit"],
