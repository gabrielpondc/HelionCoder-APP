...
const KNOWN_COMMAND_DESCRIPTIONS: Record<string, string> = {
  ...
  copy: "Copy HelionCoder's last response to clipboard as markdown",
  ...
  feedback: "Submit feedback about HelionCoder",
  ...
  init: "Initialize a new HELIONCODER.md file with codebase documentation",
  insights: "View AI insights",
  keybindings: "Open or create your keybindings configuration file",
  login: "Configure HelionCoder CLI API information",
  logout: "Clear HelionCoder CLI authentication state",
  mcp: "Manage MCP servers",
  memory: "Edit HelionCoder memory files",
  ...
  status: "Show HelionCoder status and version info",
  ...
  "team-onboarding": "Help teammates ramp on HelionCoder with a guide from your usage",
};
...
export const VIRTUAL_COMMANDS: CliCommand[] = [
  ...
  {
    name: "copy",
    description: "Copy Helion's last response to clipboard as markdown",
    aliases: [],
    _virtual: true,
    _action: "copy-last",
  },
  ...
  {
    name: "stickers",
    description: "Get Helion stickers",
    aliases: ["sticker"],
    _virtual: true,
